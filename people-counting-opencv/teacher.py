...
def detection():
    ...
    s1 = 'Desktop\people-counting-opencv\people-counting-opencv\mobilenet_ssd\MobileNetSSD_deploy.prototxt'
    model = r'Desktop\people-counting-opencv\people-counting-opencv\mobilenet_ssd\MobileNetSSD_deploy.caffemodel'
    input_data = r'Desktop\people-counting-opencv\people-counting-opencv\videos\Pedestrian.mp4'
    output = r'Desktop\people-counting-opencv\people-counting-opencv\output\output.avi'
    ...
    while True:
        ...
        cv2.line(frame, (int(W // (2.5)), 0), (int(W // (2.5)), H), (255, 0, 0), 2)
